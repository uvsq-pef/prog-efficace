...
TIP: Expérimentez ({rustlings}/04_primitive_types[rustlings], {rbp}/basic-types/numbers.html[Rust By Practice], {rbe}/primitives.html[Rust by Example])
...
TIP: Expérimentez ({rustlings}/01_variables[rustlings], {rbp}/variables.html[Rust By Practice], {rbe}/variable_bindings.html[Rust by Example])
...
TIP: Expérimentez ({rustlings}/09_strings[rustlings], {rbp}/compound-types/string.html[Rust By Practice], {rbe}/std/str.html[Rust by Example])
...
TIP: Expérimentez ({rustlings}/03_if[rustlings], {rbp}/flow-control.html[Rust By Practice], {rbe}/flow_control.html[Rust by Example])
...
TIP: Expérimentez ({rustlings}/02_functions[rustlings], {rbp}/basic-types/functions.html[Rust By Practice], {rbe}/fn.html[Rust by Example])
...
TIP: Expérimentez ({rustlings}/10_modules[rustlings], {rbp}/crate-module/intro.html[Rust By Practice], {rbe}/mod.html[Rust by Example])
...
{rl}/std/vec/struct.Vec.html[`Vec<T>`]:: un tableau de taille variable ({rustlings}/05_vecs[rustlings], {rbp}/collections/vector.html[Rust By Practice], {rbe}/std/vec.html[Rust by Example])
...
{rl}/std/option/index.html[`Option<T>`]:: pour représenter une valeur optionnel ({rustlings}/12_options[rustlings], {rbe}/std/option.html[Rust by Example])
...
** https://rust-book.cs.brown.edu/[version avec quizz]
* {rl}/std/index.html[Documentation] de la bibliothèque standard
* {rl}/reference/index.html[Référence] du langage
* {rl}/nomicon/intro.html[The Rustonomicon]

ifdef::backend-revealjs[== !]

=== Autres documents
* https://google.github.io/comprehensive-rust/[Comprehensive Rust], Google
...
* https://www.lurklurk.org/effective-rust/title-page.html[Effective Rust], _David Drysdale_, 2024
* https://cliffle.com/p/dangerust/[Learn Rust the Dangerous Way], _Cliff L. Biffle_, 2024
...
* https://grasland.pages.in2p3.fr/rust-cpp-intro/[Rust vu du C++], _Hadrien Grasland_, 2023
* https://blog.jetbrains.com/fr/rust/2024/11/22/comment-se-former-a-rust-en-2024-un-guide-complet-pour-aider-les-debutants-a-maitriser-la-programmation-rust/[Comment se former à Rust en 2024], _JetBrains_, 2024
* https://discord.com/blog/why-discord-is-switching-from-go-to-rust[Pourquoi Discord passe de Go à Rust], _Jesse Howarth_, 2020
...
* https://jrdngr.github.io/pngme_book/[PNGme: An Intermediate Rust Project], 2024

ifdef::backend-revealjs[== !]

=== Sujets spécifiques
* https://corrode.dev/blog/prototyping/[Prototyping in Rust], _Matthias Endler_, 2025
* https://www.howtocodeit.com/articles/ultimate-guide-rust-newtypes#what-are-newtype-wrappers-in-rust[The ultimate guide to Rust newtypes], _How To Code It_, 2023
* https://www.howtocodeit.com/articles/the-definitive-guide-to-rust-error-handling[The definitive guide to error handling in Rust], _How To Code It_, 2024
* https://sabrinajewson.org/blog/errors[Modular Errors in Rust], _Sabrina Jewson_, 2023
